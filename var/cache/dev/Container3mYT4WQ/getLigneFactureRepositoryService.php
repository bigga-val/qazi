 ...
 */
class getLigneFactureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LigneFactureRepository' shared autowired service.
     *
     * @return \App\Repository\LigneFactureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LigneFactureRepository.php';

        return $container->privates['App\\Repository\\LigneFactureRepository'] = new \App\Repository\LigneFactureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
