 ...
 */
class getTypeFactureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeFactureRepository' shared autowired service.
     *
     * @return \App\Repository\TypeFactureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeFactureRepository.php';

        return $container->privates['App\\Repository\\TypeFactureRepository'] = new \App\Repository\TypeFactureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
