...
/* ui-components/sweetalert.html.twig */
class __TwigTemplate_06cbae8a5c49bcef8f206d1b37a75c0b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "ui-components/sweetalert.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "ui-components/sweetalert.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "ui-components/sweetalert.html.twig", 1);
    ...
    &lt;script&gt;
        async function showAlert() {
            new window.Swal({
                ...
                imageUrl: (&quot;&#123;&#123; asset('assets/images/thumbs-up.jpg') &#125;&#125;&quot;),
                imageWidth: 224,
                imageHeight: 200,
    ...
    &lt;script&gt;
        async function showAlert() {
            new window.Swal({
                ...
                background: '#fff url(' + (&quot;&#123;&#123; asset('assets/images/sweet-bg.jpg') &#125;&#125;&quot;) + ') no-repeat 100% 100%',
            });
        }
    &lt;/script&gt;
    </pre>
        ...
        async function showAlert(type) {
            if (type === 1) {
                ...
                new window.Swal({
                    ...
                    imageUrl: (\"";
        // line 1043
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/custom-swal.svg"), "html", null, true);
        echo "\"),
                    imageWidth: 224,
                    imageHeight: 'auto',
                    imageAlt: 'Custom image',
                ...
                new window.Swal({
                    ...
                    background: '#fff url(' + (\"";
        // line 1119
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/sweet-bg.jpg"), "html", null, true);
        echo "\") +
                        ') no-repeat 100% 100%',
                });
            } else if (type === 13) {
...
";
    ...
    {
        return "ui-components/sweetalert.html.twig";
    }
    ...
    {
        return array (  1194 => 1119,  1115 => 1043,  971 => 902,  967 => 901,  68 => 4,  58 => 3,  35 => 1,);
    }
        ...
        async function showAlert(type) {
            if (type === 1) {
                ...
                new window.Swal({
                    title: 'Sweet!',
                    text: 'Modal with a custom image.',
                    imageUrl: (\"{{ asset('assets/images/custom-swal.svg') }}\"),
                    imageWidth: 224,
                    imageHeight: 'auto',
                    imageAlt: 'Custom image',
                    animation: false,
                ...
                new window.Swal({
                    ...
                    padding: '7em',
                    customClass: 'background-modal sweet-alerts',
                    background: '#fff url(' + (\"{{ asset('assets/images/sweet-bg.jpg') }}\") +
                        ') no-repeat 100% 100%',
                });
            } else if (type === 13) {
                new window.Swal({
...
{% endblock %}", "ui-components/sweetalert.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\ui-components\\sweetalert.html.twig");
    }
}
