...
class __TwigTemplate_222df89eac389d205fb067a5c0b03a3d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("components/layout/auth.html.twig", "pages/coming-soon.html.twig", 1);
    ...
    <div class=\"flex min-h-screen items-center justify-center dark:bg-dark-dark-light\">
        ...
        <div class=\"bg-[#060818] w-1/2 min-h-screen hidden lg:flex items-center justify-center p-4\">
            <img src=\"";
        // line 108
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/coming-soon.svg"), "html", null, true);
        echo "\" alt=\"coming_soon\"
...
";
    ...
    {
        return array (  174 => 108,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"flex min-h-screen items-center justify-center dark:bg-dark-dark-light\">
        ...
        <div class=\"bg-[#060818] w-1/2 min-h-screen hidden lg:flex items-center justify-center p-4\">
            <img src=\"{{ asset('assets/images/coming-soon.svg') }}\" alt=\"coming_soon\"
                class=\"lg:max-w-[370px] xl:max-w-[500px] mx-auto\" />
        </div>
    </div>
...
{% endblock %}", "pages/coming-soon.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\pages\\coming-soon.html.twig");
    }
}
