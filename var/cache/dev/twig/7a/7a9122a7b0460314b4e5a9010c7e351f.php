...
class __TwigTemplate_a6ad1495586cb0c828a2a7c3db9bb688 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["produit"]) {
            // line 24
            echo "            ";
            $context["i"] = ((isset($context["i"]) || array_key_exists("i", $context) ? $context["i"] : (function () { throw new RuntimeError('Variable "i" does not exist.', 24, $this->source); })()) + 1);
            // line 25
            echo "
            <tr>
                <td>";
            // line 27
            echo twig_escape_filter($this->env, (isset($context["i"]) || array_key_exists("i", $context) ? $context["i"] : (function () { throw new RuntimeError('Variable "i" does not exist.', 27, $this->source); })()), "html", null, true);
            echo "</td>
                <td>";
            // line 28
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "designation", [], "any", false, false, false, 28), "html", null, true);
            echo "</td>
                <td>";
            // line 29
            ...
            echo "</td>
                <td>";
            // line 30
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "prixUnitaire", [], "any", false, false, false, 30), "html", null, true);
            echo "</td>
";
            // line 32
            echo "                <td>
                    <a href=\"";
            // line 33
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_produit_show", ["id" => twig_get_attribute($this->env, $this->source, $context["produit"], "id", [], "any", false, false, false, 33)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 34
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_produit_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["produit"], "id", [], "any", false, false, false, 34)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  165 => 42,  156 => 38,  147 => 34,  143 => 33,  140 => 32,  136 => 30,  132 => 29,  128 => 28,  124 => 27,  120 => 25,  117 => 24,  111 => 23,  109 => 22,  103 => 18,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
