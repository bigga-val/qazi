...
/* apps/notes.html.twig */
class __TwigTemplate_3a669809daf69d00975d3fa0ab1ea1b7 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps/notes.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps/notes.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "apps/notes.html.twig", 1);
                                                    ...
                                                    <template x-if=\"note.thumb\">
                                                        <div class=\"p-0.5 bg-gray-300 dark:bg-gray-700 rounded-full\">
                                                            <img class=\"h-8 w-8 rounded-full object-cover\"
                                                                :src=\"`";
        // line 193
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/\${note.thumb}"), "html", null, true);
        echo "`\" />
                                                        </div>
                                                    </template>
...
";
    ...
    {
        return array (  259 => 193,  68 => 4,  58 => 3,  35 => 1,);
    }
                                            ...
                                            <div class=\"flex items-center w-max\">
                                                <div class=\"flex-none\">
                                                    <template x-if=\"note.thumb\">
                                                        <div class=\"p-0.5 bg-gray-300 dark:bg-gray-700 rounded-full\">
                                                            <img class=\"h-8 w-8 rounded-full object-cover\"
                                                                :src=\"`{{ asset('assets/images/\${note.thumb}') }}`\" />
                                                        </div>
                                                    </template>
                                                    <template x-if=\"!note.thumb && note.user\">
                                                        <div class=\"grid place-content-center h-8 w-8 rounded-full bg-gray-300 dark:bg-gray-700 text-sm font-semibold\"
...
{% endblock %}", "apps/notes.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\apps\\notes.html.twig");
    }
}
