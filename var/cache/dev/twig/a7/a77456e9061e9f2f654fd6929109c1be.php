...
class __TwigTemplate_74f09e39974d6edf771fba161ce688e7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "\" class=\"border-danger text-danger rounded border border-2 m-2 p-2\">Voir la liste</a>
            <a  href=\"";
        // line 18
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_profile", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 18, $this->source); })()), "request", [], "any", false, false, false, 18), "get", ["id"], "method", false, false, false, 18)]), "html", null, true);
