...
/* tables.html.twig */
class __TwigTemplate_28db6f8080b1dc232ee29cad19bf4d1a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "tables.html.twig", 1);
                                ...
                                <template x-for=\"data in tableData\" :key=\"data.id\">
                                    <tr>
                                        ...
                                        <td> <span class=\"badge whitespace-nowrap\"
                                                :class=\"{
                                                    'badge-outline-primary': data.status ===
                                                        'Complete',
                                                    'badge-outline-secondary': data.status ===
                                                        'Pending',
                                                    'badge-outline-info': data.status ===
                                                        'In Progress',
...
{% endblock %}", "tables.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\tables.html.twig");
    }
}
