...
/* forms/basic.html.twig */
class __TwigTemplate_1a0dca33a4752f596e3be2aa7583d9c9 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "forms/basic.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "forms/basic.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "forms/basic.html.twig", 1);
            ...
            <div class=\"panel\">
                ...
                <div class=\"mb-5\">
                    <form>
                        ...
                        <input id=\"fullname\" type=\"text\" placeholder=\"Enter Full Name\" value=\"Alan Green\"
                            class=\"form-input\" />
                    </form>
                </div>
                ...
                <div class=\"mb-5\">
                    <form class=\"space-y-5\">
                        ...
                        <div>
                            ...
                            <select id=\"ctnSelect2\" multiple=\"multiple\" class=\"form-multiselect text-white-dark\"
                                required>
                                <option>Open this select menu</option>
                                <option>One</option>
                                <option>Two</option>
                ...
                <div class=\"mb-5\">
                    <form class=\"space-y-5\">
                        <div>
                            ...
                            <input id=\"groupFname\" type=\"text\" placeholder=\"Enter First Name\"
                                class=\"form-input\" />
                        </div>
                        <div>
                            <label for=\"groupLname\">Last Name</label>
                            <input id=\"groupLname\" type=\"text\" placeholder=\"Enter Last Name\"
                                class=\"form-input\" />
                        </div>
                        <button type=\"button\" class=\"btn btn-primary !mt-6\">Submit</button>
                    </form>
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    <h5 class=\"font-semibold text-lg dark:text-white-light\">Input with badge help text (Default Left)
                    </h5>
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    <h5 class=\"font-semibold text-lg dark:text-white-light\">Input with block badge help text (Default
                        Left)</h5>
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                    ...
                    <form>
                        <div class=\"grid grid-cols-1 sm:grid-cols-3 gap-4\">
                            <div>
                                ...
                                <input id=\"inputLarge\" type=\"text\" placeholder=\"Large Input\"
                                    class=\"form-input form-input-lg\" />
                            </div>
                            <div>
                                <label for=\"inputDefault\">Default Input</label>
                                <input id=\"inputDefault\" type=\"text\" placeholder=\"Default Input\"
                                    class=\"form-input\" />
                            </div>
                            <div>
                                <label for=\"inputSmall\">Small Input</label>
                                <input id=\"inputSmall\" type=\"text\" placeholder=\"Small Input\"
                ...
                <div class=\"mb-5\">
                    <form class=\"space-y-5\">
                        <div class=\"sm:flex justify-between items-center gap-5 md:gap-20\">
                            ...
                            <input id=\"hrLargeinput\" type=\"email\" placeholder=\"name@example.com\"
                                class=\"form-input py-2.5 text-base\" />
                        </div>
                        <div class=\"sm:flex justify-between items-center gap-5 md:gap-20\">
                            <label for=\"hrDefaultinput\">Email</label>
                            <input id=\"hrDefaultinput\" type=\"email\" placeholder=\"name@example.com\"
                                class=\"form-input\" />
                        </div>
                        <div class=\"sm:flex justify-between items-center gap-5 md:gap-20\">
                            <label for=\"hrSmallinput\">Email</label>
                            <input id=\"hrSmallinput\" type=\"email\" placeholder=\"name@example.com\"
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel lg:row-start-[14]\">
                ...
                <div class=\"mb-5\">
                    <form>
                        <div>
                            <input type=\"text\" placeholder=\"Readonly input here…\"
                ...
                <div class=\"mb-5\">
                    <form class=\"space-y-5\">
                        <div>
                            ...
                            <input id=\"disInput\" type=\"text\" placeholder=\"Readonly input here…\"
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    ...
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                        href=\"javascript:;\" @click=\"toggleCode('code23')\">
                        <span class=\"flex items-center\">
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    ...
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                        href=\"javascript:;\" @click=\"toggleCode('code24')\">
                        <span class=\"flex items-center\">
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    ...
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                        href=\"javascript:;\" @click=\"toggleCode('code25')\">
                        <span class=\"flex items-center\">
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    ...
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                        href=\"javascript:;\" @click=\"toggleCode('code26')\">
                        <span class=\"flex items-center\">
    ...
    &lt;/form&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    ...
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                        href=\"javascript:;\" @click=\"toggleCode('code28')\">
                        <span class=\"flex items-center\">
...
";
    ...
    {
        return array (  1482 => 1413,  1478 => 1412,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "forms/basic.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\forms\\basic.html.twig");
    }
}
