...
/* ui-components/timeline.html.twig */
class __TwigTemplate_24a22a6ded547b3632ed6be53d8d20ce extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "ui-components/timeline.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "ui-components/timeline.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "ui-components/timeline.html.twig", 1);
    ...
    <div>
                ...
                <div class=\"mb-5\">
                    ...
                    <div class=\"sm:flex\">
                        <div
                            ...
                            <img src=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/profile-16.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                        ...
                        <div class=\"flex-1\">
                            ...
                            <div class=\"mt-4 sm:mt-7 mb-16\">
                                ...
                                <p class=\"ltr:pl-8 rtl:pr-8 text-white-dark font-semibold\"> Lorem ipsum dolor sit amet,
        ...
        echo "\" alt=\"image\"
                                    ...
                                    <img src=\"";
        // line 67
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/drag-1.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                    <img src=\"";
        // line 69
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/drag-2.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                    <img src=\"";
        // line 71
        ...
        echo "\" alt=\"image\"
                                    ...
                                    <img src=\"";
        // line 73
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/drag-4.jpg"), "html", null, true);
        echo "\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                </div>
                            </div>
                    ...
                    <div class=\"sm:flex\">
                        <div
                            ...
                            <img src=\"";
        // line 82
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/profile-7.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                                class=\"w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]\" />
                        </div>
                        <div class=\"flex-1\">
                            ...
                            <div class=\"mt-4 sm:mt-7 mb-16\">
                                ...
                                <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\"
                                    ...
                                    <path
                                        ...
                                        stroke=\"currentColor\" stroke-width=\"1.5\" />
                                    <circle opacity=\"0.5\" cx=\"16\" cy=\"8\" r=\"2\"
                                        stroke=\"currentColor\" stroke-width=\"1.5\" />
                                    <path opacity=\"0.5\"
                                ...
                                <p class=\"ltr:pl-8 rtl:pr-8 text-white-dark font-semibold\"> Lorem ipsum dolor sit amet,
                                    ...
                                    nisi ut aliquip ex ea commodo consequat. </p>
                                <div
                                    class=\"ltr:pl-8 rtl:pr-8 grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-8 gap-3 mt-6\">
                                    <img src=\"";
        // line 110
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/drag-1.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
        ...
        echo "\" alt=\"image\"
                        ...
                        <div class=\"flex-1\">
                            ...
                            <div class=\"mt-4 sm:mt-7 mb-16\">
                                ...
                                <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\"
                                    xmlns=\"http://www.w3.org/2000/svg\"
                                    class=\"w-4.5 h-4.5 text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom\">
                                    <path
    ...
    &lt;div class=&quot;mb-5&quot;&gt;
        &lt;p class=&quot;text-white-dark font-bold mb-5 text-base&quot;&gt;Today&lt;/p&gt;
        &lt;div class=&quot;sm:flex&quot;&gt;
            &lt;div class=&quot;relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block&quot;&gt;
            &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-16.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]&quot; /&gt;
            &lt;/div&gt;
            &lt;div class=&quot;flex-1&quot;&gt;
                ...
                &lt;div class=&quot;mt-4 sm:mt-7 mb-16&quot;&gt;
                    &lt;svg&gt; ... &lt;/svg&gt;
                    &lt;h6 class=&quot;inline-block font-bold mb-2 text-lg&quot;&gt;Trending Style&lt;/h6&gt;
                    &lt;p class=&quot;ltr:pl-8 rtl:pr-8 text-white-dark font-semibold&quot;&gt; Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. &lt;/p&gt;
                    &lt;div class=&quot;ltr:pl-8 rtl:pr-8 flex space-x-1 rtl:space-x-reverse mt-6&quot;&gt;
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-16.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/drag-1.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/drag-2.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-16.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/drag-4.jpg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;/div&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
        ...
        &lt;div class=&quot;sm:flex&quot;&gt;
            &lt;div class=&quot;relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block&quot;&gt;
            &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-7.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]&quot; /&gt;
            &lt;/div&gt;
            &lt;div class=&quot;flex-1&quot;&gt;
                ...
                &lt;div class=&quot;mt-4 sm:mt-7 mb-16&quot;&gt;
                    ...
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/drag-1.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-16.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&
                    quot;w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;&#123;&#123; asset('assets/images/drag-4.jpg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;/div&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    ...
    &lt;/div&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    <h5 class=\"font-semibold text-lg dark:text-white-light\">Modern</h5>
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
        ...
        echo "\" alt=\"timeline\"
                                ...
                                <div class=\"p-5\">
                                    ...
                                    <p class=\"mb-3 text-white-dark\">Map where your photos were taken and discover local
                                        points of interest. Map where your photos. Map where your photos were taken and
                                        discover.</p>
                        ...
                        <li class=\"relative mb-12 before:clear-both before:table after:clear-both after:table\">
                            ...
                            <div
                                ...
                                <div>
                                    <img src=\"";
        // line 289
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/menu-heade.jpg"), "html", null, true);
        echo "\" alt=\"timeline\"
                                        class=\"w-full rounded-t-md\" />
                                </div>
                                <div class=\"p-5\">
        ...
        echo "\" alt=\"timeline\"
                ...
                <template x-if=\"codeArr.includes('code2')\">
                    <pre class=\"code overflow-auto !bg-[#191e3a] p-4 rounded-md text-white\">
    &lt;!-- modern --&gt;
    &lt;ul class=&quot;relative py-12 before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:bottom-0 before:left-1/2 before:top-0 before:w-[3px] before:-ml-[1.5px] max-w-[900px] mx-auto table&quot;&gt;
        &lt;li class=&quot;relative mb-12 before:clear-both before:table after:clear-both after:table&quot;&gt;
            ...
            &lt;div class=&quot;relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-left rtl:sm:float-right before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full ltr:before:-right-[37px] rtl:before:-left-[37px] before:top-10 sm:before:block before:hidden&quot;&gt;
                &lt;div&gt;
                &lt;img src=&quot;&#123;&#123; asset('assets/images/carousel1.jpeg') &#125;&#125;&quot; alt=&quot;timeline&quot; class=&quot;w-full rounded-t-md&quot; /&gt;
                &lt;/div&gt;
                &lt;div class=&quot;p-5&quot;&gt;
                    &lt;h4 class=&quot;mb-3 text-info text-lg font-semibold&quot;&gt;Front-End Framework&lt;/h4&gt;
        ...
        &lt;li class=&quot;relative mb-12 before:clear-both before:table after:clear-both after:table&quot;&gt;
            ...
            &lt;div class=&quot;relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-right rtl:sm:float-left before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full  ltr:before:-left-[37px] rtl:before:-right-[37px] before:top-10 sm:before:block before:hidden&quot;&gt;
                &lt;div&gt;
                &lt;img src=&quot;&#123;&#123; asset('assets/images/menu-heade.jpg') &#125;&#125;&quot; alt=&quot;timeline&quot; class=&quot;w-full rounded-t-md&quot; /&gt;
                &lt;/div&gt;
                &lt;div class=&quot;p-5&quot;&gt;
                    &lt;h4 class=&quot;mb-3 text-primary text-lg font-semibold&quot;&gt;Web Development&lt;/h4&gt;
                    &lt;p class=&quot;mb-3 text-white-dark&quot;&gt;Map where your photos were taken and discover local points of interest. Map where your photos. Map where your photos were taken and discover.&lt;/p&gt;
                    ...
                    <div class=\"max-w-[900px] mx-auto\">
                        <div class=\"flex\">
                            ...
                            <div class=\"p-2.5 self-center ltr:ml-2.5 rtl:ltr:mr-2.5 rtl:ml-2.5\">
                                <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px]\">Updated
                                    Server Logs</p>
                                <p class=\"text-white-dark text-xs font-bold self-center min-w-[100px] max-w-[100px]\">25
                                    mins ago</p>
                            </div>
                        </div>
                        <div class=\"flex\">
                            <p
                                ...
                                12:45</p>
                            <div
                                class=\"relative before:absolute before:left-1/2 before:-translate-x-1/2 before:top-[15px] before:w-2.5 before:h-2.5 before:border-2 before:border-secondary before:rounded-full after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-secondary after:rounded-full\">
                            </div>
                            <div class=\"p-2.5 self-center ltr:ml-2.5 rtl:ltr:mr-2.5 rtl:ml-2.5\">
                                <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px]\">Backup Files
                                    EOD</p>
                                <p class=\"text-white-dark text-xs font-bold self-center min-w-[100px] max-w-[100px]\">2
                                    hrs ago</p>
                            </div>
                        </div>
                        <div class=\"flex\">
                            ...
                            <div class=\"p-2.5 self-center ltr:ml-2.5 rtl:ltr:mr-2.5 rtl:ml-2.5\">
                                <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px]\">Send Mail to
                                    HR and Admin</p>
                                <p class=\"text-white-dark text-xs font-bold self-center min-w-[100px] max-w-[100px]\">4
                                    hrs ago</p>
                            </div>
                        </div>
                        <div class=\"flex\">
                            <p
                                ...
                                16:00</p>
                            <div
                                class=\"relative before:absolute before:left-1/2 before:-translate-x-1/2 before:top-[15px] before:w-2.5 before:h-2.5 before:border-2 before:border-danger before:rounded-full after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-danger after:rounded-full\">
                            </div>
                            <div class=\"p-2.5 self-center ltr:ml-2.5 rtl:ltr:mr-2.5 rtl:ml-2.5\">
                                <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px]\">Conference
                                    call with Marketing Manager.</p>
                                <p class=\"text-white-dark text-xs font-bold self-center min-w-[100px] max-w-[100px]\">6
                                    hrs ago</p>
                            </div>
                        </div>
                        <div class=\"flex\">
                            <p
                                ...
                                17:00</p>
                            <div
                                class=\"relative before:absolute before:left-1/2 before:-translate-x-1/2 before:top-[15px] before:w-2.5 before:h-2.5 before:border-2 before:border-warning before:rounded-full after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-warning after:rounded-full\">
                            </div>
                            <div class=\"p-2.5 self-center ltr:ml-2.5 rtl:ltr:mr-2.5 rtl:ml-2.5\">
                                <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px]\">Collected
                                    documents from <a href=\"javascript:void(0);\">Sara</a></p>
                                <p class=\"text-white-dark text-xs font-bold self-center min-w-[100px] max-w-[100px]\">9
                                    hrs ago</p>
                            </div>
                        </div>
                        <div class=\"flex\">
                            <p
                                ...
                                16:00</p>
                            <div
                                class=\"relative before:absolute before:left-1/2 before:-translate-x-1/2 before:top-[15px] before:w-2.5 before:h-2.5 before:border-2 before:border-info before:rounded-full\">
                            </div>
                            <div class=\"p-2.5 self-center ltr:ml-2.5 rtl:ltr:mr-2.5 rtl:ml-2.5\">
                                <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px]\">Server
                                    rebooted successfully</p>
                                <p class=\"text-white-dark text-xs font-bold self-center min-w-[100px] max-w-[100px]\">8
                                    hrs ago</p>
                            </div>
                        </div>
                    </div>
    ...
    &lt;/div&gt;
            ...
            <div class=\"panel\">
                <div class=\"flex items-center justify-between mb-5\">
                    <h5 class=\"font-semibold text-lg dark:text-white-light\">With Images</h5>
                    <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                ...
                <div class=\"mb-5\">
                    <div
                        class=\"max-w-[900px] mx-auto text-center ltr:sm:text-left rtl:sm:text-right space-y-3 sm:space-y-0\">
                        <div class=\"sm:flex items-center\">
                            <p class=\"text-[#3b3f5c] dark:text-white-light text-base font-semibold p-2.5\">09:00</p>
                            <div
                                class=\"p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full\">
                                <img src=\"";
        // line 592
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/profile-16.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                                    class=\"w-11 h-11 rounded-full relative z-[1] mx-auto\" />
                            </div>
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
                                25 mins ago</p>
                            <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px] p-2.5\">Conference
                                call with Marketing Manager.</p>
                        </div>
                        <div class=\"sm:flex items-center\">
        ...
        echo "\" alt=\"image\"
                            ...
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
                                2 hrs ago</p>
                            <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px] p-2.5\">Server
                                rebooted successfully</p>
                        </div>
                        <div class=\"sm:flex items-center\">
                            ...
                            <div
                                ...
                                <img src=\"";
        // line 618
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/profile-2.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                                    class=\"w-11 h-11 rounded-full relative z-[1] mx-auto\" />
                            </div>
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
                                4 hrs ago</p>
                            <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px] p-2.5\">Backup
                                Files EOD</p>
                        </div>
                        <div class=\"sm:flex items-center\">
                            ...
                            <div
                                ...
                                <img src=\"";
        // line 631
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/profile-3.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                                    class=\"w-11 h-11 rounded-full relative z-[1] mx-auto\" />
                            </div>
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
                                6 hrs ago</p>
                            <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px] p-2.5\">Collected
                                documents from Sara</p>
                        </div>
                        <div class=\"sm:flex items-center\">
                            ...
                            <div class=\"p-2.5 relative\">
                                <img src=\"";
        // line 643
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/profile-4.jpeg"), "html", null, true);
        echo "\" alt=\"image\"
                                    class=\"w-11 h-11 rounded-full relative z-[1] mx-auto\" />
                            </div>
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
                                9 hrs ago</p>
                            <p class=\"text-[#3b3f5c] dark:text-white-light font-semibold text-[13px] p-2.5\">PDF file
                                Download</p>
                        </div>
                    </div>
                </div>
    ...
    &lt;div class=&quot;max-w-[900px] mx-auto text-center ltr:sm:text-left rtl:sm:text-right space-y-3 sm:space-y-0&quot;&gt;
        &lt;div class=&quot;sm:flex items-center&quot;&gt;
            &lt;p class=&quot;text-[#3b3f5c] dark:text-white-light text-base font-semibold p-2.5&quot;&gt;09:00&lt;/p&gt;
            &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-16.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
            &lt;/div&gt;
        ...
        &lt;div class=&quot;sm:flex items-center&quot;&gt;
            &lt;p class=&quot;text-[#3b3f5c] dark:text-white-light text-base font-semibold p-2.5&quot;&gt;10:00&lt;/p&gt;
            &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-1.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
            &lt;/div&gt;
        ...
        &lt;div class=&quot;sm:flex items-center&quot;&gt;
            &lt;p class=&quot;text-[#3b3f5c] dark:text-white-light text-base font-semibold p-2.5&quot;&gt;11:00&lt;/p&gt;
            &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-2.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
            &lt;/div&gt;
        ...
        &lt;div class=&quot;sm:flex items-center&quot;&gt;
            &lt;p class=&quot;text-[#3b3f5c] dark:text-white-light text-base font-semibold p-2.5&quot;&gt;12:00&lt;/p&gt;
            &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-3.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
            &lt;/div&gt;
        ...
        &lt;div class=&quot;sm:flex items-center&quot;&gt;
            &lt;p class=&quot;text-[#3b3f5c] dark:text-white-light text-base font-semibold p-2.5&quot;&gt;01:00&lt;/p&gt;
            &lt;div class=&quot;p-2.5 relative&quot;&gt;
            &lt;img src=&quot;&#123;&#123; asset('assets/images/profile-4.jpeg') &#125;&#125;&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
            &lt;/div&gt;
...
";
    ...
    {
        return "ui-components/timeline.html.twig";
    }
    ...
    {
        return array (  851 => 707,  847 => 706,  781 => 643,  766 => 631,  750 => 618,  734 => 605,  718 => 592,  450 => 327,  428 => 308,  406 => 289,  384 => 270,  271 => 160,  266 => 158,  261 => 156,  256 => 154,  251 => 152,  219 => 123,  207 => 114,  202 => 112,  197 => 110,  166 => 82,  154 => 73,  149 => 71,  144 => 69,  139 => 67,  134 => 65,  106 => 40,  68 => 4,  58 => 3,  35 => 1,);
    }
            ...
            <div class=\"panel\">
                ...
                <div class=\"mb-5\">
                    ...
                    <div class=\"sm:flex\">
                        <div
                            class=\"relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block\">
                            <img src=\"{{ asset('assets/images/profile-16.jpeg') }}\" alt=\"image\"
                                class=\"w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]\" />
                        </div>
                        <div class=\"flex-1\">
                            <h4 class=\"text-primary text-xl font-bold text-center ltr:sm:text-left rtl:sm:text-right\">
                            ...
                            <div class=\"mt-4 sm:mt-7 mb-16\">
                                ...
                                <div class=\"ltr:pl-8 rtl:pr-8 flex space-x-1 rtl:space-x-reverse mt-6\">
                                    <img src=\"{{ asset('assets/images/profile-16.jpeg') }}\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                    <img src=\"{{ asset('assets/images/drag-1.jpeg') }}\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                    <img src=\"{{ asset('assets/images/drag-2.jpeg') }}\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                    <img src=\"{{ asset('assets/images/profile-16.jpeg') }}\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                    <img src=\"{{ asset('assets/images/drag-4.jpg') }}\" alt=\"image\"
                                        class=\"w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none\" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class=\"sm:flex\">
                        <div
                            class=\"relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block\">
                            <img src=\"{{ asset('assets/images/profile-7.jpeg') }}\" alt=\"image\"
                                class=\"w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]\" />
                        </div>
                        <div class=\"flex-1\">
                            <h4 class=\"text-primary text-xl font-bold text-center ltr:sm:text-left rtl:sm:text-right\">
                    ...
                    <ul
                        ...
                        <li class=\"relative mb-12 before:clear-both before:table after:clear-both after:table\">
                            ...
                            <div
                                class=\"relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-left rtl:sm:float-right before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full ltr:before:-right-[37px] rtl:before:-left-[37px] before:top-10 sm:before:block before:hidden\">
                                <div>
                                    <img src=\"{{ asset('assets/images/carousel1.jpeg') }}\" alt=\"timeline\"
                                        class=\"w-full rounded-t-md\" />
                                </div>
                                <div class=\"p-5\">
                                    <h4 class=\"mb-3 text-info text-lg font-semibold\">Front-End Framework</h4>
                        ...
                        <li class=\"relative mb-12 before:clear-both before:table after:clear-both after:table\">
                            ...
                            <div
                                class=\"relative border border-[#ebedf2] dark:border-[#191e3a] max-w-[320px] mx-auto sm:max-w-full w-full sm:w-[46%] shadow-[0_20px_20px_rgba(126,142,177,0.12)] rounded-md bg-white dark:bg-[#191e3a] ltr:sm:float-right rtl:sm:float-left before:absolute before:bg-[#ebedf2] dark:before:bg-[#191e3a] before:w-[37px] before:h-[3px] before:rounded-full  ltr:before:-left-[37px] rtl:before:-right-[37px] before:top-10 sm:before:block before:hidden\">
                                <div>
                                    <img src=\"{{ asset('assets/images/menu-heade.jpg') }}\" alt=\"timeline\"
                                        class=\"w-full rounded-t-md\" />
                                </div>
                                <div class=\"p-5\">
                                    <h4 class=\"mb-3 text-primary text-lg font-semibold\">Web Development</h4>
                ...
                <div class=\"mb-5\">
                    <div
                        ...
                        <div class=\"sm:flex items-center\">
                            ...
                            <div
                                class=\"p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full\">
                                <img src=\"{{ asset('assets/images/profile-2.jpeg') }}\" alt=\"image\"
                                    class=\"w-11 h-11 rounded-full relative z-[1] mx-auto\" />
                            </div>
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
                        ...
                        <div class=\"sm:flex items-center\">
                            ...
                            <div
                                class=\"p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full\">
                                <img src=\"{{ asset('assets/images/profile-3.jpeg') }}\" alt=\"image\"
                                    class=\"w-11 h-11 rounded-full relative z-[1] mx-auto\" />
                            </div>
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
                        ...
                        <div class=\"sm:flex items-center\">
                            <p class=\"text-[#3b3f5c] dark:text-white-light text-base font-semibold p-2.5\">01:00</p>
                            <div class=\"p-2.5 relative\">
                                <img src=\"{{ asset('assets/images/profile-4.jpeg') }}\" alt=\"image\"
                                    class=\"w-11 h-11 rounded-full relative z-[1] mx-auto\" />
                            </div>
                            <p
                                class=\"text-white-dark text-xs font-bold self-center sm:min-w-[100px] sm:max-w-[100px] p-2.5 mt-5 sm:mt-0\">
...
{% endblock %}", "ui-components/timeline.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\ui-components\\timeline.html.twig");
    }
}
