...
class __TwigTemplate_9cdaa71bfc4b884cd5f1f934078091ba extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "forms/select2.html.twig", 1);
    ...
    <link rel='stylesheet' type='text/css' href='";
        // line 5
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/css/nice-select2.css"), "html", null, true);
        echo "'>
        ...
        <div class=\"pt-5 space-y-8\">
            <div class=\"panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap\">
                ...
                <span class=\"ltr:mr-3 rtl:ml-3\">Documentation: </span><a
                    href=\"https://www.npmjs.com/package/nice-select2\" target=\"_blank\"
                    class=\"block hover:underline\">https://www.npmjs.com/package/nice-select2</a>
            </div>
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Nested</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Disabling options</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
    ...
    &lt;/script&gt;
                ...
                <!-- Placeholder -->
                <div class=\"panel lg:row-start-3\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Placeholder</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Searchable</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Multiple select</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
    ...
    <script src=\"";
        // line 379
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/js/nice-select2.js"), "html", null, true);
        echo "\"></script>
    <script>
        document.addEventListener(\"DOMContentLoaded\", function(e) {
            // default
...
";
    ...
    {
        return array (  454 => 379,  448 => 376,  444 => 375,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "forms/select2.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\forms\\select2.html.twig");
    }
}
