...
class __TwigTemplate_7c7d33dd5d0a678eedd493db5f9013b1 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        ";
        // line 5
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 5, $this->source); })()), "designation", [], "any", false, false, false, 5), 'widget', ["attr" => ["class" => "form-input"]]);
        echo "
    </div>
    <div>
    ...
    <div>
        ...
        ";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "prixUnitaire", [], "any", false, false, false, 13), 'widget', ["attr" => ["class" => "form-input"]]);
        echo "
    </div>
<br>
...
";
    ...
    {
        return array (  75 => 17,  71 => 16,  65 => 13,  58 => 9,  51 => 5,  47 => 3,  43 => 1,);
    }
...
{#    {{ form_widget(form) }}#}
    <div>
        <label for=\"\">Nom du Produit</label>
        {{ form_widget(form.designation, {'attr': {'class': 'form-input'}}) }}
    </div>
    <div>
        <label for=\"\">Description</label>
    ...
    <div>
        <label for=\"\">Prix unitaire</label>
        {{ form_widget(form.prixUnitaire, {'attr': {'class': 'form-input'}}) }}
    </div>
<br>
    <button class=\"btn btn-success\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "produit/_form.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\produit\\_form.html.twig");
    }
}
