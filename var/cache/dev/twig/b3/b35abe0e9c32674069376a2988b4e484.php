...
class __TwigTemplate_d89dd8411956e7eaed57973568835261 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        echo "\">Nouveau Service</a>
                        ...
                        <li>
                            <a href=\"";
        // line 204
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_facture_new_facture");
        echo "\">Nouvelle facture</a>
                        </li>
...
";
    ...
    {
        return array (  352 => 277,  349 => 276,  314 => 241,  308 => 238,  271 => 204,  261 => 197,  255 => 194,  218 => 160,  212 => 157,  206 => 154,  200 => 151,  166 => 119,  161 => 111,  155 => 108,  51 => 7,  43 => 1,);
    }
    ...
    <nav x-data=\"sidebar\"
        ...
        <div class=\"bg-white dark:bg-[#0e1726] h-full\">
            <div class=\"flex justify-between items-center px-4 py-3\">
                <a href=\"/\" class=\"main-logo flex items-center shrink-0\">
                    <img class=\"w-8 ml-[5px] flex-none\" src=\"{{ asset('assets/images/logo.svg') }}\"
                        alt=\"image\" />
                    <span
                        class=\"text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light\">VRISTO</span>
                </a>
...
{#                        </li>#}
                ...
                <li class=\"menu nav-item\">
                    ...
                    <ul x-cloak x-show=\"activeDropdown === 'service'\" x-collapse
                        ...
                        <li>
                            <a href=\"{{ path(\"app_facture_new_facture\") }}\">Nouvelle facture</a>
                        </li>
