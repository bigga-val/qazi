...
/* apps/contacts.html.twig */
class __TwigTemplate_ec3c6787140c1812093426f0d375b056 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps/contacts.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps/contacts.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "apps/contacts.html.twig", 1);
                                    ...
                                    <td>
                                        <div class=\"flex items-center w-max\">
                                            <div x-show=\"contact.path\" class=\"w-max\">
                                                <img :src=\"`";
        // line 166
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/\${contact.path}"), "html", null, true);
        echo "`\"
...
";
    ...
    {
        return "apps/contacts.html.twig";
    }
    ...
    {
        return array (  285 => 216,  232 => 166,  68 => 4,  58 => 3,  35 => 1,);
    }
                            ...
                            <template x-for=\"contact in filterdContactsList\" :key=\"contact.id\">
                                <tr>
                                    <td>
                                        <div class=\"flex items-center w-max\">
                                            <div x-show=\"contact.path\" class=\"w-max\">
                                                <img :src=\"`{{ asset('assets/images/\${contact.path}') }}`\"
                                                    class=\"h-8 w-8 rounded-full object-cover ltr:mr-2 rtl:ml-2\"
                                                    alt=\"avatar\" />
                                            </div>
                                            <div x-show=\"!contact.path && contact.name\"
                ...
                <template x-for=\"contact in filterdContactsList\" :key=\"contact.id\">
                    <div class=\"bg-white dark:bg-[#1c232f] rounded-md overflow-hidden text-center shadow relative\">
                        <div
                            ...
                            <template x-if=\"contact.path\">
                                <img class=\"object-contain w-4/5 max-h-40 mx-auto\"
                                    :src=\"`{{ asset('assets/images/\${contact.path}') }}`\" />
                            </template>
                        </div>
                        <div class=\"px-6 pb-24 -mt-10 relative\">
                            <div class=\"shadow-md bg-white dark:bg-gray-900 rounded-md px-2 py-4\">
...
{% endblock %}", "apps/contacts.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\apps\\contacts.html.twig");
    }
}
