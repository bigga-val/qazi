...
/* ui-components/notifications.html.twig */
class __TwigTemplate_49466c2c943d7357c2cc5d25dad9d540 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "ui-components/notifications.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "ui-components/notifications.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "ui-components/notifications.html.twig", 1);
                    ...
                    <div class=\"mb-5\">
                        <div class=\"flex items-center justify-center\">
                            <button type=\"button\" class=\"btn btn-primary\"
                                @click=\"showMessage('Hello, world! This is a toast message.')\">Open Toast</button>
                        </div>
                    </div>
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel lg:row-span-2\">
                    ...
                    <div class=\"mb-5\">
                        <h6 class=\"font-semibold text-base dark:text-white-light mb-3 text-center\">Top Position</h6>
                        <div class=\"flex items-center justify-center mb-10 gap-2\">
                            <button type=\"button\" class=\"btn btn-success\"
                                @click=\"showMessage('Example notification text.',\$store.app.rtlClass === 'rtl' ? 'top-end' : 'top-start')\">Top
                                Left</button>
                            <button type=\"button\" class=\"btn btn-secondary\"
                                @click=\"showMessage('Example notification text','top')\">Top Center</button>
                            <button type=\"button\" class=\"btn btn-info\"
                                @click=\"showMessage('Example notification text.', \$store.app.rtlClass === 'rtl' ? 'top-start' : 'top-end')\">Top
                                Right</button>
                        </div>
                        <h6 class=\"font-semibold text-base dark:text-white-light mb-3 text-center\">Bottom Position</h6>
                        <div class=\"flex items-center justify-center gap-2\">
                            <button type=\"button\" class=\"btn btn-dark\"
                                @click=\"showMessage('Example notification text.', \$store.app.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start')\">Bottom
                                Left</button>
                            <button type=\"button\" class=\"btn btn-primary\"
                                @click=\"showMessage('Example notification text.','bottom')\">Bottom Center</button>
                            <button type=\"button\" class=\"btn btn-secondary\"
                                @click=\"showMessage('Example notification text.', \$store.app.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end')\">Bottom
                                Right</button>
                        </div>
                    </div>
                    <template x-if=\"codeArr.includes('code2')\">
                        <pre class=\"code overflow-auto !bg-[#191e3a] p-4 rounded-md text-white\">
    &lt;!-- top left --&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-success&quot; @click=&quot;showMessage('Example notification text.',\$store.app.rtlClass === 'rtl' ? 'top-end' : 'top-start')&quot;&gt;Top Left&lt;/button&gt;
    ...
    &lt;!-- bottom left --&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-dark&quot; @click=&quot;showMessage('Example notification text.',\$store.app.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start')&quot;&gt;Bottom Left&lt;/button&gt;

    &lt;!-- bottom center --&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot; @click=&quot;showMessage('Example notification text.','bottom')&quot;&gt;Bottom Center&lt;/button&gt;

    &lt;!-- bottom right --&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-secondary&quot; @click=&quot;showMessage('Example notification text.',\$store.app.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end')&quot;&gt;Bottom Right&lt;/button&gt;
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">No Action</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                    ...
                    <div class=\"mb-5\">
                        <div class=\"flex items-center justify-center\">
                            <button type=\"button\" class=\"btn btn-success\"
                                @click=\"showMessage('Example notification text.', 'bottom-start',false)\">No
                                Action</button>
                        </div>
                    </div>
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Click Callback</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                    ...
                    <div class=\"mb-5\">
                        <div class=\"flex items-center justify-center\">
                            <button type=\"button\" class=\"btn btn-info\" @click=\"clickCallable()\">Click
                                Callback</button>
                        </div>
                    </div>
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Duration</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                    ...
                    <div class=\"mb-5\">
                        <div class=\"flex items-center justify-center\">
                            <button type=\"button\" class=\"btn btn-dark\"
                                @click=\"showMessage(msg='Example notification text.', position= 'bottom-start', duration=5000)\">Duration</button>
                        </div>
                    </div>
    ...
    &lt;/script&gt;
                ...
                <div class=\"panel lg:col-span-2\">
                    <div class=\"flex items-center justify-between mb-5\">
                        <h5 class=\"font-semibold text-lg dark:text-white-light\">Background Color</h5>
                        <a class=\"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600\"
                    ...
                    <div class=\"mb-5\">
                        <div
                            class=\"grid grid-cols-2 sm:grid-cols-1 sm:flex items-center justify-center gap-2 colored-toast\">
                            <div>
                                <button type=\"button\" class=\"btn btn-primary\"
                                    @click=\"coloredToast('primary')\">Primary</button>
                                <div id=\"primary-toast\"></div>
                            </div>
                            <div>
                                <button type=\" button\" class=\"btn btn-secondary\"
                                    @click=\"coloredToast('secondary')\">Secondary</button>
                                <div id=\"secondary-toast\"></div>
                            </div>
                            <div>
                                <button type=\"button\" class=\"btn btn-success\"
                                    @click=\"coloredToast('success')\">Success</button>
                                <div id=\"success-toast\"></div>
                            </div>
                            <div>
                                <button type=\"button\" class=\"btn btn-danger\"
                                    @click=\"coloredToast('danger')\">Danger</button>
                                <div id=\"danger-toast\"></div>
                            </div>
                            <div>
                                <button type=\"button\" class=\"btn btn-warning\"
                                    @click=\"coloredToast('warning')\">Warning</button>
                                <div id=\"warning-toast\"></div>
                            </div>
                            <div>
                                <button type=\"button\" class=\"btn btn-info\"
                                    @click=\"coloredToast('info')\">Info</button>
...
";
    ...
    {
        return "ui-components/notifications.html.twig";
    }
    ...
    {
        return array (  528 => 459,  524 => 458,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "ui-components/notifications.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\ui-components\\notifications.html.twig");
    }
}
