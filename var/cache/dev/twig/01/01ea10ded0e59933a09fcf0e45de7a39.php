...
/* apps/chat.html.twig */
class __TwigTemplate_19e71712529cf4b52be54e9d2a51bac3 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps/chat.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps/chat.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "apps/chat.html.twig", 1);
                                ...
                                <div class=\"flex-1\">
                                    <div class=\"flex items-center\">
                                        <div class=\"flex-shrink-0 relative\"><img
                                                :src=\"`";
        // line 167
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/\${person.path}"), "html", null, true);
        echo "`\"
                        ...
                        <div class=\"flex justify-between items-center p-4\">
                            <div class=\"flex items-center space-x-2 rtl:space-x-reverse\">
                                ...
                                <div class=\"relative flex-none\">
                                    <img :src=\"`";
        // line 323
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/\${selectedUser.path}"), "html", null, true);
        echo "`\"
                                    ...
                                    <div class=\"flex items-start gap-3\"
                                        ...
                                        <div class=\"flex-none\"
                                            ...
                                            <template x-if=\"selectedUser.userId === message.fromUserId\">
                                                <img :src=\"`";
        // line 501
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/\${loginUser.path}"), "html", null, true);
        echo "`\"
...
";
    ...
    {
        return array (  583 => 505,  576 => 501,  395 => 323,  236 => 167,  77 => 11,  68 => 4,  58 => 3,  35 => 1,);
    }
...
<div x-data=\"chat\">
        <div class=\"flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full sm:min-h-0\"
            ...
            <div class=\"panel p-4 flex-none overflow-hidden max-w-xs w-full absolute xl:relative z-10 space-y-4 xl:h-full hidden xl:block\"
                ...
                <div class=\"flex justify-between items-center\">
                    <div class=\"flex items-center\">
                        <div class=\"flex-none\"><img src=\"{{ asset('assets/images/profile-34.jpeg') }}\"
                                class=\"rounded-full h-12 w-12 object-cover\" /></div>
                        <div class=\"mx-3\">
                            <p class=\"mb-1 font-semibold\">Alon Smith</p>
                            <p class=\"text-xs text-white-dark\">Software Developer</p>
                        ...
                        <template x-for=\"person in searchUsers\">
                            <button type=\"button\"
                                ...
                                <div class=\"flex-1\">
                                    <div class=\"flex items-center\">
                                        <div class=\"flex-shrink-0 relative\"><img
                                                :src=\"`{{ asset('assets/images/\${person.path}') }}`\"
                                                class=\"rounded-full h-12 w-12 object-cover\" />
                                            <template x-if=\"person.active\">
                                                <div class=\"absolute bottom-0 ltr:right-0 rtl:left-0\">
                    ...
                    <div class=\"relative h-full\">
                        <div class=\"flex justify-between items-center p-4\">
                            <div class=\"flex items-center space-x-2 rtl:space-x-reverse\">
                                ...
                                <div class=\"relative flex-none\">
                                    <img :src=\"`{{ asset('assets/images/\${selectedUser.path}') }}`\"
                                        class=\"rounded-full w-10 h-10 sm:h-12 sm:w-12 object-cover\" />
                                    <div class=\"absolute bottom-0 ltr:right-0 rtl:left-0\">
                                ...
                                <template x-for=\"message in selectedUser.messages\">
                                    <div class=\"flex items-start gap-3\"
                                        ...
                                        <div class=\"flex-none\"
                                            :class=\"{ 'order-2': selectedUser.userId === message.fromUserId }\">
                                            <template x-if=\"selectedUser.userId === message.fromUserId\">
                                                <img :src=\"`{{ asset('assets/images/\${loginUser.path}') }}`\"
                                                    class=\"rounded-full h-10 w-10 object-cover\" />
                                            </template>
                                            <template x-if=\"selectedUser.userId !== message.fromUserId\">
                                                <img :src=\"`{{ asset('assets/images/\${selectedUser.path}') }}`\"
...
{% endblock %}", "apps/chat.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\apps\\chat.html.twig");
    }
}
