...
/* users/user-account-settings.html.twig */
class __TwigTemplate_6fa7f4a9e8f0fd40e3f518c86ff91c24 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "users/user-account-settings.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "users/user-account-settings.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "users/user-account-settings.html.twig", 1);
                                    ...
                                    <div class=\"border-b border-[#ebedf2] dark:border-[#1b2e4b]\">
                                        <div class=\"flex items-start justify-between py-3\">
                                            <div class=\"flex-none ltr:mr-4 rtl:ml-4\">
                                                <img src=\"";
        // line 294
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/card-americanexpress.svg"), "html", null, true);
        echo "\"
                                                    alt=\"image\" />
                                            </div>
                                            <h6 class=\"text-[#515365] font-bold dark:text-white-dark text-[15px]\">
                                    ...
                                    <div class=\"border-b border-[#ebedf2] dark:border-[#1b2e4b]\">
                                        <div class=\"flex items-start justify-between py-3\">
                                            <div class=\"flex-none ltr:mr-4 rtl:ml-4\">
                                                <img src=\"";
        // line 309
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/card-mastercard.svg"), "html", null, true);
        echo "\"
                                                    alt=\"image\" />
                                            </div>
                                            <h6 class=\"text-[#515365] font-bold dark:text-white-dark text-[15px]\">
                                    ...
                                    <div>
                                        <div class=\"flex items-start justify-between py-3\">
                                            <div class=\"flex-none ltr:mr-4 rtl:ml-4\">
                                                <img src=\"";
        // line 324
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/card-visa.svg"), "html", null, true);
        echo "\"
                                                    alt=\"image\" />
                                            </div>
                                            <h6 class=\"text-[#515365] font-bold dark:text-white-dark text-[15px]\">
                                    ...
                                    <label class=\"inline-flex cursor-pointer\">
                                        ...
                                        <span>
                                            <img class=\"ms-3\" width=\"100\" height=\"68\" alt=\"settings-dark\"
                                                src=\"";
        // line 449
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/settings-light.svg"), "html", null, true);
        echo "\" />
                                        </span>
                                    </label>
                                    ...
                                    <label class=\"inline-flex cursor-pointer\">
                                        ...
                                        <span>
                                            <img class=\"ms-3\" width=\"100\" height=\"68\" alt=\"settings-light\"
                                                src=\"";
        // line 458
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/settings-dark.svg"), "html", null, true);
        echo "\" />
                                        </span>
                                    </label>
                                </div>
...
";
    ...
    {
        return "users/user-account-settings.html.twig";
    }
    ...
    {
        return array (  539 => 458,  527 => 449,  399 => 324,  381 => 309,  363 => 294,  166 => 100,  68 => 4,  58 => 3,  35 => 1,);
    }
                            ...
                            <div class=\"panel\">
                                ...
                                <div class=\"mb-5\">
                                    <div class=\"border-b border-[#ebedf2] dark:border-[#1b2e4b]\">
                                        <div class=\"flex items-start justify-between py-3\">
                                            <div class=\"flex-none ltr:mr-4 rtl:ml-4\">
                                                <img src=\"{{ asset('assets/images/card-americanexpress.svg') }}\"
                                                    alt=\"image\" />
                                            </div>
                                            <h6 class=\"text-[#515365] font-bold dark:text-white-dark text-[15px]\">
                                                Mastercard <span
                                    ...
                                    <div class=\"border-b border-[#ebedf2] dark:border-[#1b2e4b]\">
                                        <div class=\"flex items-start justify-between py-3\">
                                            <div class=\"flex-none ltr:mr-4 rtl:ml-4\">
                                                <img src=\"{{ asset('assets/images/card-mastercard.svg') }}\"
                                                    alt=\"image\" />
                                            </div>
                                            <h6 class=\"text-[#515365] font-bold dark:text-white-dark text-[15px]\">
                                                American Express<span
                                    ...
                                    <div>
                                        <div class=\"flex items-start justify-between py-3\">
                                            <div class=\"flex-none ltr:mr-4 rtl:ml-4\">
                                                <img src=\"{{ asset('assets/images/card-visa.svg') }}\"
                                                    alt=\"image\" />
                                            </div>
                                            <h6 class=\"text-[#515365] font-bold dark:text-white-dark text-[15px]\">
                                                Visa<span
...
{% endblock %}", "users/user-account-settings.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\users\\user-account-settings.html.twig");
    }
}
