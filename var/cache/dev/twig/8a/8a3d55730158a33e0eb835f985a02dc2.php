...
class __TwigTemplate_ba1862a50de2c0089a9b440bdea7bff0 extends Template
{
    private $source;
    private $macros = [];
...
<div>
    ...
    ";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "prix", [], "any", false, false, false, 13), 'widget', ["attr" => ["class" => "form-input"]]);
        echo "
</div>
<br>
...
", "service/_form.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\service\\_form.html.twig");
    }
}
