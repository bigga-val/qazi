...
/* datatables/alt-pagination.html.twig */
class __TwigTemplate_5dc47364910e1fa263c1e7fdcd3a13b2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "datatables/alt-pagination.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "datatables/alt-pagination.html.twig"));

        $this->parent = $this->loadTemplate("components/layout/default.html.twig", "datatables/alt-pagination.html.twig", 1);
 ...
 <script src=\"";
    ...
    <div x-data=\"pagination\">
        <div class=\"panel\">
            <h5 class=\"md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light\">Alt Pagination
            </h5>
            <table id=\"myTable1\" class=\"whitespace-nowrap\"></table>
        </div>

        <div class=\"panel mt-6\">
            <h5 class=\"md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light\">Disable First
                Last Pagination</h5>
            <table id=\"myTable2\" class=\"whitespace-nowrap\"></table>
        </div>

        <div class=\"panel mt-6 no-number-pagination\">
            <h5 class=\"md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light\">Pagination
                Without Number</h5>
            <table id=\"myTable3\" class=\"whitespace-nowrap\"></table>
        </div>

        <div class=\"panel mt-6 no-number-pagination next-prev-pagination\">
            <h5 class=\"md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light\">Next Previous
            </h5>
...
";
    ...
    {
        return "datatables/alt-pagination.html.twig";
    }
...
{% endblock %}", "datatables/alt-pagination.html.twig", "C:\\Users\\TEST\\Downloads\\symfony\\vristo-symfony-main\\templates\\datatables\\alt-pagination.html.twig");
    }
}
